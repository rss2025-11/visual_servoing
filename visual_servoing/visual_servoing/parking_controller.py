...
class ParkingController(Node):
    ...
    def __init__(self):
        ...
        self.parking_distance = 0.5#.75 # meters; try playing with this number!
        self.relative_x = 0
        self.relative_y = 0
        ...
        self.ANGLE_TOL = 0.025 # about 2.5 degrees
        self.DRIVE_SPEED = 0.7 #1.0
        self.DIST_TOL = 0.1 # may be too small
        self.DIST_BUFFER = 0.5 #0.0 
